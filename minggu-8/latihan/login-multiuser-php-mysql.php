...
<center><div id="content-inner-login">
	<form action="act-login.php?op=in" method="POST"> 
		<table cellpadding="0" cellspacing="5" bgcolor="pink" width="50%">
	...
	<table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; width: 50%;">
		<tbody>
		<tr bgcolor="#E40082" height="40">
			<td style="width: 25%;color: white"><center><b>Username</b></center></td>
			<td style="width: 25%;color: white"><center><b>Nama</b></center></td>
			<td style="width: 25%;color: white"><center><b>Password</b></center></td>
			<td style="width: 25%;color: white"><center><b>Hak Akses</b></center></td>
		</tr>
		<tr bgcolor="pink" height="32">
		...
		<tr bgcolor="#F0F0F0" height="32">
			...
			<td style="width: 25%;"><center>Azhahra Risky</center></td>
			<td style="width: 25%;"><center>operator</center></td>
